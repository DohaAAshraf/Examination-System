...
EXEC instructor.spCreateExam @CourseID=2, @InstructorID=2, @ExamType='Exam', @IntakeID=1, @BranchID=1, @TrackID=4, @StartTime='2024-06-23 10:00:00.000', @EndTime='2024-06-23 12:00:00.000', @TotalTime=120, @AllowanceOptions=NULL
...
Exec instructor.spAddQuestionToExam @ExamID= 15, @QuestionID=10 , @Degree=4
...
EXEC instructor.spAddRandomQuestionToExam  @ExamID = 15 ,  @CourseID =2 , @Degree = 5.00

--checkStudentAnswer
EXEC student.SP_checkStudentAnswer @StudentID =3 ,	@studentExamID =25 , 	@QuestionID = 2  ,@studentanswer = 0
EXEC student.SP_checkStudentAnswer @StudentID =3 ,	@studentExamID =25 , 	@QuestionID = 10  ,@studentanswer = 2

EXEC student.SP_checkStudentAnswer @StudentID =4 ,	@studentExamID =4 , 	@QuestionID = 4  ,@studentanswer = 'Mitochondrea'
...
Exec instructor.SP_calculateTotalDegree @studentId =3,@examId =15



--Update degree manually by Instructor if the StudentAnswer not valid compared to BestAcceptedAnswer
Exec  instructor.SP_UpdateStudentAnswerDegree @StudentAnswerID= 28, @Degree= 10



--Insert StudentExam 
Exec instructor.SP_StudentExam  @StudentID= 3 ,@ExamID= 11  ,@StartTime = '2024-12-01 10:00:00.000',@EndTime ='2024-12-01 12:00:00.000'
Exec instructor.SP_StudentExam  @StudentID= 3 ,@ExamID= 15  , @StartTime='2024-06-23 10:00:00.000', @EndTime='2024-06-23 12:00:00.000'

--StudentID not exist 
Exec instructor.SP_StudentExam  @StudentID= 6 ,@ExamID= 11  ,@StartTime = '2024-12-01 10:00:00.000',@EndTime ='2024-12-01 12:00:00.000'

--Exam not exist
Exec instructor.SP_StudentExam  @StudentID= 3 ,@ExamID= 55  ,@StartTime = '2024-12-01 10:00:00.000',@EndTime ='2024-12-01 12:00:00.000'
